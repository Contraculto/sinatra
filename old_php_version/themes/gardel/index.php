...
<head>
	<meta charset="UTF-8" />
	<title>Gardel</title>
	<link rel="stylesheet" href="themes/gardel/sinatra.css" media="all" />
	<link rel="shortcut icon" href="themes/gardel/img/favicon.ico">
	<?php
		...
		<script type="text/javascript">
			...
			function (){
				$.getJSON('includes/info.php', function(data) {
					...
					$('#volume_info').html("<strong>"+data.vol_level+"%</strong>. Cambiado por "+data.vol_user+".</p>");
...
?>
			...
			<div id="votes">
				<p>Votos: <span id="votes_info">Cargando...</span> <a class="control" name="skip" rel="skip">Skip</a> <a class="control" name="like" rel="skip">Like</a></p>
			</div>
			<div id="volume">
